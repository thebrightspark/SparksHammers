...
{
    //Hammer Heads
    public static final Item hammerHeadWood = new ItemResource(Names.Items.HAMMER_HEAD_WOOD);
    //Hammers
    ...
    public static final ItemHammer hammerThor = new ItemHammerMjolnir();

    //Excavator Heads
    public static final Item excavatorHeadWood = new ItemResource(Names.Items.EXCAVATOR_HEAD_WOOD);
    //Excavators
