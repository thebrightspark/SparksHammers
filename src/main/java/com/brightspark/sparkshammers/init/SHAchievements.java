...
public class SHAchievements
{
    ...
    public static Achievement diamondHammer = new Achievement("achievement.diamondHammer", "diamondHammer", 0, 2, SHItems.hammerDiamond, craftingTable);
    ...
    public static void init()
    {
        ...
        AchievementPage.registerAchievementPage(new AchievementPage(Reference.MOD_ID,
                woodHammer, craftingTable, diamondHammer, mjolnir, mjolnirNope, mjolnirFallDeath));
    }
}
