...
public class BlockEventHandler
{
    ...
    public static void onBlockBreak(BreakEvent event)
    {
        ...
        {
            if(player.capabilities.isCreativeMode || getPlayerMining(player) == null)
            {
    ...
    public static void onHarvestBlock(BlockEvent.HarvestDropsEvent event)
    {
        ...
        if(heldStack == null || !(heldStack.getItem() instanceof ItemHammerNetherStar)) return;
